...
Player::Player()
{
	...
	mKeyBinding[sf::Keyboard::LControl] = Jump;
	...
	mActionBinding[Jump].action = derivedAction<Fighter>([](Fighter& f, sf::Time)
	{
		f.jump();
	});
	mActionBinding[Jump].category = Category::PlayerFighter;
}
